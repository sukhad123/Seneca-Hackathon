...
//    const handleMarkerClick = (title,center,marker, populationDensity) => {
//        setSelectedMarkerTitle(title);
//        setShowMarkerDetails(true);
//        setSelectMarkerPopulation(populationDensity)
...
//                 onClick={()=>handleMarkerClick(marker.title,marker.position,marker,null)}
...
//               onClick={() => handleMarkerClick(DenslyPopulated[city].title, DenslyPopulated[city].center, null, DenslyPopulated[city].population)}
//          options={{
//            strokeColor: "#FF8080",
//            strokeOpacity: 0.8,
//            strokeWeight: 2,
...
//             onClick={() => handleMarkerClick(GrowingCities[city].title, GrowingCities[city].center, null, GrowingCities[city].details)}
//    icon={{
        ...
        fillOpacity: 0.35 // Fill opacity
                ...
                {Object.keys(GrowingCities).map((city) => (
                    <MarkerF
                        key={city}
                        position={GrowingCities[city].center}
                        onClick={() => handleMarkerClick(GrowingCities[city].title, GrowingCities[city].population, GrowingCities[city].center)}
                        icon={{
                            url: "https://maps.google.com/mapfiles/ms/icons/green-dot.png",
                            scaledSize: { width: 40, height: 40 } // Set the width and height directly
                        }}
